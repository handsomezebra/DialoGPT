...
def run_model():
    ...
    parser.add_argument("--agent_checkpoint", type=str, default='')
    parser.add_argument("--customer_checkpoint", type=str, default='')
    ...
    while True:
        ...
        out = generate_sequence(agent_model, context_tokens, position_ids=position_ids,
        ...
        out = generate_sequence(customer_model, context_tokens, position_ids=position_ids,
                                length=args.generation_length, temperature=args.temperature, 
                                top_k=args.top_k, top_p=args.top_p) 
